                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        ...
                        {tournament.status === 'PUBLISHED' ? 'OPEN FOR REGISTRATION' : tournament.status}
                      </span>
                    </div>
                      ...
                      <>
                        {user?.profile?.role === 'CAPTAIN' ? (
                          <Link
                            ...
                            className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors shadow-sm text-center"
                          >
                            Create Team
                          </Link>
                        ) : (
